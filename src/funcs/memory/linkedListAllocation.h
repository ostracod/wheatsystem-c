...
///DESC This file provides an implementation of the functions decribed by `abstract/memory/allocation`. This implementation uses a linked list to store heap allocations.

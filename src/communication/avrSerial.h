...
///DESC This file provides platform-specific definitions for interacting with the serial bus of an AVR chip. These definitions are used by `platforms/avr` for communication during debug mode.
